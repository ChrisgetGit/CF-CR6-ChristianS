...
for (var i in asc) {
    document.getElementById("row1").innerHTML += asc[i].render();
}
/*
const asc = locationsArray.slice().sort((a, b) => b.current - a.current)
//sort algorithm
console.log(asc)
